...
fn is_opposite(one: Direction, two: Direction) -> bool {
    match one {
        Direction::North => two == Direction::South,
        Direction::South => two == Direction::North,
        Direction::East => two == Direction::West,
...
mod tests {
    ...
    fn basic() {
        ...
        let a = [North, West, South, East, West];
